...
class TestMainPage():
    ...
    @allure.description('Cоздаем драйвер для браузера Firefox. Открываем главную страницу сервиса Яндекс.Самокат.Создаем объект класса главной страницы')
    @classmethod
    def setup_class(cls):
    ...
    def test_important_questions_list_1 (self):
        self.main_page.click_first_question_button()
        actual_text=self.main_page.get_first_question_answer().text
    ...
    def test_important_questions_list_2 (self):
        self.main_page.click_second_question_button()
        actual_text=self.main_page.get_second_question_answer().text
    ...
    def test_important_questions_list_3 (self):
        self.main_page.click_third_question_button()
        actual_text=self.main_page.get_third_question_answer().text
    ...
    def test_important_questions_list_4 (self):
        self.main_page.click_fourth_question_button()
        actual_text=self.main_page.get_fourth_question_answer().text
    ...
    def test_important_questions_list_5 (self):
        self.main_page.click_fifth_question_button()
        actual_text=self.main_page.get_fifth_question_answer().text
    ...
    def test_important_questions_list_6 (self):
        self.main_page.click_sixth_question_button()
        actual_text=self.main_page.get_sixth_question_answer().text
    ...
    def test_important_questions_list_7 (self):
        self.main_page.click_seventh_question_button()
        actual_text=self.main_page.get_seventh_question_answer().text
    ...
    def test_important_questions_list_8 (self):
        self.main_page.click_eighth_question_button()
        actual_text=self.main_page.get_eighth_question_answer().text
